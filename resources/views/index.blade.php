                                        ...
                                        <form method="post" action="{{route('user.updateuser')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input required="" value="{{$userData->phone}}"  class="form-control" name="phone" type="text" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label>Address <span class="required">*</span></label>
                                                    <input required="" value="{{$userData->address}}"  class="form-control" name="address" type="text" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <img id="imagepre" height="150" width="150" src="{{(!empty($userData->profile_pic)) ? asset('uploads/user/'.$userData->profile_pic) : asset('uploads/user/user.jpg')}}" alt="" >
                                                </div>
                                                <div class="col-md-12">
