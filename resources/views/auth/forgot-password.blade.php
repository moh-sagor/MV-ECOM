                                ...
                                <div class="padding_eight_all bg-white">
                                    <form method="post"  action="{{ route('password.email') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="email" required="" name="email" placeholder="Type Your Email Address" />
                                            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-heading btn-block hover-up" name="login"> Send Reset password Link</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
